...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "Webild",
    images: [{ url: "https://images.pexels.com/photos/6779716/pexels-photo-6779716.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" }],
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Webild - SaaS for Modern Business",
    description: "Innovative SaaS solutions for modern enterprises.",
